...
export default function CTAButton({ href, children, variant = 'primary', className = '' }) {
  ...
  const base = 'inline-flex items-center gap-2 font-semibold text-sm lg:text-base tracking-wide px-7 py-3.5 lg:px-9 lg:py-4 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-offset-2'
  const variants = {
